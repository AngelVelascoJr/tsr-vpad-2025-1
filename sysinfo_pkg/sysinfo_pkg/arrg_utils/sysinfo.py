...
This module provides the SysInfoTool class, which includes methods to gather various system information
such as CPU usage, memory status, disk space, network interface details, and ROS (Robot Operating System)
environment variables.

Classes:
    - SysInfoTool: A class with methods for retrieving and managing system information.

Usage example:
    from arrg_utils import SysInfoTool
...
class SysInfoTool:
    ...
    def __init__(self) -> None:
        """
        Initializes the SysInfoTool instance with system command strings and regex patterns.
        """
